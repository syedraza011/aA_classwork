...
//or equal to the number. For example: the summation of 3 is 6 
//because 1 + 2 + 3 = 6, the summation of 6 is 21 
//because 1 + 2 + 3 + 4 + 5 + 6 = 21. Write a function 
//summationSequence that takes in two numbers: start and length.
